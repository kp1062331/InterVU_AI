      ...
      <div className="mt-14 grid grid-cols-1 gap-8 md:grid-cols-3">
        {steps.map((item, index) => {
          ...
          return (
            <div
              key={item.step}
              className="group relative flex flex-col justify-between rounded-2xl border border-rule bg-paper p-7 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:border-black/20 hover:shadow-xl hover:shadow-black/5"
            >
