      ...
      <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {assessmentFeatures.map((item) => {
          ...
          return (
            <div
              key={item.number}
              className="group relative flex flex-col justify-between rounded-2xl border border-rule bg-surface/60 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-black/20 hover:bg-white hover:shadow-xl hover:shadow-black/5"
            >
              <div>
