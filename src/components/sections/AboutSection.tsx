...
export function AboutSection() {
  return (
    <section id="features" className="bg-paper border-t border-rule" aria-labelledby="features-heading">
          ...
          <Container className="relative z-10">
            <ScrollReveal className="flex flex-col items-start lg:w-3/5 lg:pr-10 py-14 sm:py-20">
              ...
              <p className="mt-4 text-base leading-relaxed text-ink-soft">
                Prepare with realistic company-grade assessments. Practice under test conditions, see how you perform, and know exactly where to improve.
              </p>
            </ScrollReveal>
          </Container>
        </div>
